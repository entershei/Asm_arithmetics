                ...
                global          _start
_start:
; rsp -- указатель на верхушку стека
                mov             rcx, 128
                sub             rsp, 2 * 128 * 8
                mov             rdi, rsp
                call            read_long
...
; multiplication two long number
...
read_char:
                ...
                mov             rsi, rsp
                mov             rdx, 1
; rsi -- место на стеке, куда считать, rdi -- откуда (stdin), rax -- 0 == "считать", rdx -- сколько байт считать
                syscall
